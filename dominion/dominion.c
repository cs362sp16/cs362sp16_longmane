...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
      ...
      return new_mine(state, currentPlayer, handPos, choice2);
    ...
    case smithy:
      ...
      return new_smithy(state, currentPlayer, handPos);
		
    case village:

      return new_village(state, currentPlayer, handPos);
	...
	return new_great_hall(state, currentPlayer, handPos);
	...
	return new_outpost(state, currentPlayer, handPos);
